  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* The approved desktop artwork is the single header at every width.
           Portrait and landscape mobile only scale this complete one-row image. */
        .cmd-approved-header {
          position: sticky;
          top: 0;
          z-index: 50;
      ...
      <CommanderErrorBoundary>
        <header className="cmd-approved-header" data-artwork="approved-global-header">
          <img
            ...
            width="1648"
            height="168"
            className="cmd-approved-header__art"
            aria-hidden="true"
            fetchpriority="high"
            decoding="sync"
          />
